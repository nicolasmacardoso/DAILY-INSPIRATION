...
import { Heart, Share2, Copy, Check, Edit, Trash2, MoreVertical } from "lucide-react"
...
export default function UserQuoteCard({ quote, onEdit, onDelete, featured = false }: UserQuoteCardProps) {
        ...
        <div className="space-y-4">
          <div className="flex justify-between items-start">
            <blockquote
              ...
              } font-medium text-gray-900 dark:text-white leading-relaxed flex-1 pr-4`}
            >
              "{quote.text}"
            </blockquote>

            <div className="relative">
              <Button variant="ghost" size="sm" onClick={() => setShowActions(!showActions)} className="h-8 w-8 p-0">
              ...
              {showActions && (
                <div className="absolute right-0 top-8 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-md shadow-lg z-10 min-w-[120px]">
                  <Button
                    ...
                    className="w-full justify-start text-left px-3 py-2 hover:bg-gray-100 dark:hover:bg-gray-700"
                  >
                  ...
                  <Button
                    ...
                    className="w-full justify-start text-left px-3 py-2 hover:bg-red-50 dark:hover:bg-red-900/20 text-red-600 dark:text-red-400"
                  >
